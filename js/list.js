...
function dec(){
 ...
 function setTotalAmount(quantity){
  ...
  setTotalAmount1(quantity);
   ...
   //Fourth card
   const quantityText9=document.getElementById(`quantity-text9`);
  const showQuantity9=document.getElementById(`show-quantity9`);
  const showTotal9=document.getElementById(`show-total9`);
  function inc9(){
  let quantity=parseInt(quantityText9.innerText);
  if(quantity<=5){
    quantityText9.innerText = ++quantity;
  }
  else
  {
    alert("You can't add more than 6 items....")
  }
  setTotalAmount9(quantity);
}
function dec9(){
  const quantity=parseInt(quantityText9.innerText);

  if(quantity>1){
    quantityText9.innerText = quantity-1;
  }
  else
  {
    alert("You can't add less than 1 items....")
...
//end
 function setTotalAmount9(quantity){
    showQuantity9.innerText =` ${quantity}*164`;
  showTotal9.innerText =`Total:${quantity*164}`;
  }
   //Fifth card
